...
\begin{enumerate}[label=1.\arabic*]
  ...
  \item Analyse the difficulties that arose from development and conclude why research in this area has been lacklustre
\end{enumerate}
...
\begin{itemize}
  ...
  \item \textbf{Phase 3}. Analysing the journey of the project and concluding why it has been void of attention
\end{itemize}
...
The second phase will oversee the development process of the Chinese Wall daemon \verb_cwalld_. This phase will follow the waterfall principle. By this phase, the daemon will have 
...
SELinux is designed such that only subjects can only access objects if the policy allows its labels to. In standard SELinux, these labels are all static and are only changed by the user under unique circumstances.
