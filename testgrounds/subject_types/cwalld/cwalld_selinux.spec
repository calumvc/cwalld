...
Version:	1.0
Release:	1%{?dist}
Summary:	SELinux policy module for cwalld
...
%description
This package installs and sets up the  SELinux policy security module for cwalld.
...
install -m 644 %{SOURCE2} %{buildroot}%{_mandir}/man8/cwalld_selinux.8
install -d %{buildroot}/etc/selinux/targeted/contexts/users/


%post
semodule -n -i %{_datadir}/selinux/packages/cwalld.pp
...
%files
%attr(0600,root,root) %{_datadir}/selinux/packages/cwalld.pp
%{_datadir}/selinux/devel/include/contrib/cwalld.if
%{_mandir}/man8/cwalld_selinux.8.*
